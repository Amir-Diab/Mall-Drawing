...
int cloTexture1, cloTexture2, cloTexture3, cloTexture4, cloTexture5, cloTexture6, cloTexture7, cloTexture8, cloTexture9,glassTexture;
...
Model_3DS* manModel, * carModel, * sofaModel;
...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
	...
	floorTexture = LoadTexture((char*)"assets/textures/table/2.bmp");
	...
	coneTexture = LoadTexture((char*)"assets/textures/cone.bmp");
	...
	resTexture1 = LoadTexture((char*)"assets/textures/restaurants/3.bmp");
	resTexture2 = LoadTexture((char*)"assets/textures/restaurants/1.bmp");
	resTexture3 = LoadTexture((char*)"assets/textures/restaurants/2.bmp");
	resTexture4 = LoadTexture((char*)"assets/textures/restaurants/4.bmp");
	resTexture5 = LoadTexture((char*)"assets/textures/restaurants/5.bmp");
	resTexture6 = LoadTexture((char*)"assets/textures/restaurants/6.bmp");
	...
	clo4 = LoadTexture((char*)"assets/textures/clothes/c4.bmp");
	...
	streetTexture = LoadTexture((char*)"assets/textures/street.bmp");
	ORIGI4 = LoadTexture((char*)"assets/textures/origi-4.bmp");
	grassTexture=LoadTexture((char*)"assets/textures/grass.bmp");
	flowerTexture = LoadTexture((char*)"assets/textures/flowers.bmp");
	buildingTexture=LoadTexture((char*)"assets/textures/building.bmp");
...
void DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	//////////////////////////////////////////////////////////////////////
	draw.rectangleXY(1, 0, -42.8, 13, 6, 1, cloTexture3, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleXY(14, 0, -43.2, -13, 6, -1, clo5, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleXY(0, 0, -49.9, 17, 6, 1, clo4, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleYZ(0.2, 0, -43, 6.9, 6, 1, clo1, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleYZ(16.9, 0, -49.9, -6.9, 6, -1, clo2, 0, 0, 1, 0, 1, 1, 0, 1);
	//
	...
	//
	draw.rectangleXY(78, 6, -8, -11, 6, -1, cloTexture2, 0, 0, 0.35, 0, 0.35, 1, 0, 1);
	draw.rectangleXY(64, 6, -8, -11, 6, -1, cloTexture2, 0.67, 0, 1, 0, 1, 1, 0.76, 1);
	draw.rectangleXY(77.8, 6, -0.2, -24.6, 6, -1, clo4, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleXY(53.2, 6, -7.9, 10.6, 6, 1, clo5, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleXY(67, 6, -7.9, 11, 6, 1, clo3, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleYZ(53.2, 6, -0.2, 7.7, 6, 1, clo1, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleYZ(77.8, 6, -0.2, 7.7, 6, 1, clo2, 0, 0, 1, 0, 1, 1, 0, 1);
	...
	//
	draw.rectangleXY(78, 0, -8, -11, 6, -1, cloTexture7, 0, 0.2, 0.35, 0.2, 0.35, 0.9, 0, 0.9);
	draw.rectangleXY(64, 0, -8, -11, 6, -1, cloTexture7, 0.65, 0.2, 1, 0.2, 1, 0.9, 0.65, 0.9);
	draw.rectangleXY(77.8, 0, -0.2, -24.6, 6, -1, clo4, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleXY(53.2, 0, -7.9, 10.6, 6, 1, clo5, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleXY(67, 0, -7.9, 11, 6, 1, clo3, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleYZ(53.2, 0, -0.2, 7.7, 6, 1, clo1, 0, 0, 1, 0, 1, 1, 0, 1);
	draw.rectangleYZ(77.8, 0, -0.2, 7.7, 6, 1, clo2, 0, 0, 1, 0, 1, 1, 0, 1);
	...
	//skybox
	draw.rectangleXZ(-10, 0, 5,88, 5,1, wallTexture2, 0, 0, 10, 0, 10, 1, 0, 1);
	draw.rectangleXZ(-10, 0, 0, 28, 18,1, wallTexture2, 0, 0, 3, 0, 3, 3, 0, 3);	
	draw.rectangleXZ(-10, 0, 0, 10, 31,1, wallTexture2, 0, 0, 0.3, 0, 0.3, 6, 0, 6);
